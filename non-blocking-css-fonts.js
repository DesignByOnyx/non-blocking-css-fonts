   ...
   function waitForWebfonts() {
       for(var i = 0, l = fontNames.length; i < l; ++i) {
         ...
         // Characters that vary significantly among different fonts
           ...
           // Now apply the font family to the node (quotes needed for names with spaces)
...
}(document, 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700|Exo+2:400,500,700', ['Exo 2', 'Source Sans Pro']));